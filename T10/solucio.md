# 📘 Solucio.md – T10: Green IT (Tecnologia Verda)

A continuació tens la solució completa de la tasca **Green IT**, organitzada per activitats i enllaços als documents corresponents:

---

## 🧠 Activitat 1 – Introducció, definicions i anàlisi actual
...
## 📊 Activitat 3 – Recerca aplicada i política interna
...
La pràctica completa et permet:

- Entendre què és el **Green IT** i la seva importància.
- Analitzar pràctiques reals i aplicar-les al nostre entorn.
- Definir una **política sostenible** amb objectius i indicadors per mesurar l’impacte.

Consulta els tres documents enlazats per veure cada part de la solució desenvolupada.
